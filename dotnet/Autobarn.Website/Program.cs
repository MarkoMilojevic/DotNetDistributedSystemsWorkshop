        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    ...
                    {
                        string pfxPassword = Environment.GetEnvironmentVariable("UrsatilePfxPassword");
                        Action<ListenOptions> https = UseCertIfAvailable(@"d:\workshop.ursatile.com\ursatile.com.pfx", pfxPassword);
